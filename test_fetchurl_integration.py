...
class TestIntegration(unittest.TestCase):
    def test_fetchurl_server_integration(self):
        # SIGALRM must be cleared in finally: a failed assert or mid-test
        # exception used to leave the alarm armed and poison later tests.
        old_handler = None
        alarm_armed = False
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                try:
                    ...
                    try:
                        ...
                        os.environ["FETCHURL_SERVER"] = (
                            f'"http://{host}:{port}/api/fetchurl"'
                        )
